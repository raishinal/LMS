...
public class EmailController {
    ...
    static final String emailFromRecipient = "devilamakrishna0@gmail.com";
    ...
    @RequestMapping(value = {"/Admin/Mail", "emailForm"}, method = RequestMethod.GET)
    public ModelAndView showEmailForm(ModelMap model) {
        modelViewObj = new ModelAndView("admin/emailForm");
        return  modelViewObj;       
    }
...
//        System.out.println("\nMessage Send Successfully.... Hurrey!\n");
        ...
        modelViewObj = new ModelAndView("admin/emailForm","messageObj","Thank You! Your Email Has Been Sent!");
        return  modelViewObj;   
    }
}
